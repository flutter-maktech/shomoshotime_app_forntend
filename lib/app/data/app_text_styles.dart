...
abstract class AppTextStyles {
  ...
  static TextStyle get light38 =>
      TextStyle(fontSize: 38.sp, fontWeight: FontWeight.w300);
  static TextStyle get regular38 =>
      TextStyle(fontSize: 38.sp, fontWeight: FontWeight.w400);
  static TextStyle get medium38 =>
      TextStyle(fontSize: 38.sp, fontWeight: FontWeight.w500);
  static TextStyle get bold38 =>
      TextStyle(fontSize: 38.sp, fontWeight: FontWeight.w600);

  static TextStyle get light40 =>
      TextStyle(fontSize: 40.sp, fontWeight: FontWeight.w300);
  ...
  static TextStyle get spaceGroteskLarge12 => TextStyle(
    fontSize: 12.sp,
    fontWeight: FontWeight.w700,
    fontFamily: "SpaceGrotesk",
  );

  static TextStyle get spaceGroteskLarge16 => TextStyle(
    fontSize: 16.sp,
    fontWeight: FontWeight.w700,
    fontFamily: "SpaceGrotesk",
  );

  static TextStyle get spaceGroteskLarge20 => TextStyle(
    fontSize: 20.sp,
    fontWeight: FontWeight.w700,
    fontFamily: "SpaceGrotesk",
  );

  static TextStyle get spaceGroteskLarge24 => TextStyle(
    fontSize: 24.sp,
    fontWeight: FontWeight.w700,
    fontFamily: "SpaceGrotesk",
  );

  static TextStyle get spaceGroteskLarge28 => TextStyle(
    fontSize: 28.sp,
    fontWeight: FontWeight.w700,
    fontFamily: "SpaceGrotesk",
  );

  static TextStyle get spaceGroteskLarge32 => TextStyle(
    fontSize: 32.sp,
    fontWeight: FontWeight.w700,
    fontFamily: "SpaceGrotesk",
  );

  static TextStyle get spaceGroteskLarge36 => TextStyle(
    fontSize: 36.sp,
    fontWeight: FontWeight.w700,
    fontFamily: "SpaceGrotesk",
  );

  static TextStyle get spaceGroteskLarge40 => TextStyle(
    fontSize: 40.sp,
    fontWeight: FontWeight.w700,
    fontFamily: "SpaceGrotesk",
  );
